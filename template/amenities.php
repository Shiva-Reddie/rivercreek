                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center mb-48">
                                ...
                                <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s" data-wow-delay="0s">Thousands of luxury home enthusiasts just like you
                                    visit our website.
                                </p>
                            </div>
                            <div class="widget-tabs style-2 ">
                                ...
                                <div class="widget-content-tab">
                                    <div class="widget-content-inner active">
                                        <div class="tf-grid-layout lg-col-3 md-col-2 loadmore-item">
                                            <div class="box-house hover-img fl-item ">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="images/section/box-house-12.jpg" src="images/section/box-house-10.jpg" alt="">
                                                    </a>
                                            ...
                                            <div class="box-house hover-img fl-item ">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="images/section/box-house-11.jpg" src="images/section/box-house-11.jpg" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                            Featured</li>
                                            ...
                                            <div class="box-house hover-img fl-item ">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="images/section/box-house-13.jpg" src="images/section/box-house-12.jpg" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                            Featured</li>
                                            ...
                                            <div class="box-house hover-img fl-item">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="images/section/box-house-13.jpg" src="images/section/box-house-13.jpg" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                            Featured</li>
                                            ...
                                            <div class="box-house hover-img fl-item">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="images/section/box-house.jpg" src="images/section/box-house.jpg" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                            Featured</li>
                                            ...
                                            <div class="box-house hover-img fl-item">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="images/section/box-house-2.jpg" src="images/section/box-house-2.jpg" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                            Featured</li>
                                        ...
                                        <button class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore view-more-button ">Load
                                    ...
                                    <div class="widget-content-inner ">
                                        ...
                                        <button class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore-1 view-more-button-1  ">Load
                                            more property</button>
                                    </div>
                                    <div class="widget-content-inner ">
                                        <div class="tf-grid-layout lg-col-3 md-col-2 loadmore-item-2">
                                            <div class="box-house hover-img fl-item-2">
                                                <div class="image-wrap">
                                                    <a href="#">
                                                        <img class="lazyload" data-src="images/section/box-house-10.jpg" src="images/section/box-house-10.jpg" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                            Featured</li>
                                            ...
                                            <div class="box-house hover-img fl-item-2">
                                                <div class="image-wrap">
                                                    <a href="#">
                                                        <img class="lazyload" data-src="images/section/box-house-12.jpg" src="images/section/box-house-12.jpg" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                            Featured</li>
                                        ...
                                        <button class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore-2 view-more-button-2 ">Load
                                            more property</button>
                                    </div>
                                    <div class="widget-content-inner ">
                                        ...
                                        <button class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore-3 view-more-button-3 ">Load
                                            more property</button>
                                    </div>
                                    <div class="widget-content-inner ">
                                        ...
                                        <button class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore-4 view-more-button-4 ">Load
                                            more property</button>
                                    </div>
                                    <div class="widget-content-inner ">
                                        ...
                                        <button class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore-5 view-more-button-5 ">Load
                                            more property</button>
                                    </div>
                                </div>
                            </div>
